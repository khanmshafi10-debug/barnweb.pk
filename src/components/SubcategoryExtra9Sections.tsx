...
export const SubcategoryExtra9Sections: React.FC<SubcategoryExtra9SectionsProps> = ({ subData }) => {
  ...
  // Cinematic 3D Motion curves with blur reveal & depth physics
  ...
  return (
    <div className="space-y-0 text-[#1C241D] overflow-hidden font-sans">
      ...
      <section className="py-20 lg:py-28 bg-[#FBF9F4] border-t border-[#2D4233]/10 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-[#483D8B]/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            {/* Left Image Collage with Cinematic 3D Shadow */}
            <motion.div className="lg:col-span-6 relative perspective-1000" variants={cinematicReveal}>
              <motion.div 
                className="relative rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.18)] border border-[#2D4233]/15 aspect-4/3 group"
                whileHover={{ scale: 1.025, rotateY: -2, rotateX: 1, transition: { duration: 0.4 } }}
              >
                <img 
                  src={getImage('rare')} 
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  <span className="inline-block text-xs font-bold uppercase tracking-widest text-[#FDD229] mb-1 drop-shadow-md">
                    High Altitude Terroir
                  </span>
                  <h4 className="font-serif text-xl sm:text-2xl font-bold drop-shadow-md">{subData.origin}</h4>
                </div>
              </motion.div>
              <div className="absolute -bottom-6 -right-6 w-52 bg-[#2D4233] text-white p-5 rounded-2xl shadow-[0_15px_35px_rgba(45,66,51,0.35)] border border-white/20 hidden sm:block backdrop-blur-md">
                <span className="block font-serif text-2xl font-bold text-[#FDD229] drop-shadow-sm">{subData.altitude}</span>
                <span className="text-xs text-white/80 font-medium">Extreme Foraging Elevation</span>
              </div>
            </motion.div>

            {/* Right Copy */}
            <motion.div className="lg:col-span-6 space-y-6" variants={cinematicReveal}>
              <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-[#2D4233]/10 text-[#2D4233] text-xs font-bold uppercase tracking-widest shadow-2xs">
                <BarnRoofMotif color="#2D4233" height={14} />
                <span>Limited Annual Yield</span>
              </div>
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1C241D] leading-tight tracking-tight">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <motion.div 
                  ...
                  className="p-5 bg-white rounded-2xl border border-[#E2E8F0] shadow-sm transition-all duration-300"
                >
                  <span className="block text-xs font-bold uppercase tracking-wider text-[#2D4233] mb-1">Harvest Window</span>
                  <span className="font-serif text-lg font-bold text-[#1C241D]">Peak 4-Week Window</span>
                </motion.div>
                <motion.div 
                  whileHover={{ y: -4, shadow: '0 12px 30px rgba(0,0,0,0.08)' }}
                  className="p-5 bg-white rounded-2xl border border-[#E2E8F0] shadow-sm transition-all duration-300"
                >
                  <span className="block text-xs font-bold uppercase tracking-wider text-[#B58600] mb-1">Purity Grade</span>
                  <span className="font-serif text-lg font-bold text-[#1C241D]">{subData.purityGrade}</span>
                </motion.div>
              </div>
            </motion.div>
      ...
      <section className="py-20 lg:py-28 bg-[#162017] text-white relative overflow-hidden">
        {/* Dual Cinematic Ambient Orbs */}
        <div className="absolute top-1/3 left-[-100px] w-[500px] h-[500px] bg-[#483D8B]/25 rounded-full blur-[140px] pointer-events-none animate-pulse" />
        <div className="absolute bottom-1/4 right-[-100px] w-[500px] h-[500px] bg-[#FDD229]/15 rounded-full blur-[140px] pointer-events-none" />
          ...
          >
            ...
            {[
              ...
              <motion.div 
                ...
                className="bg-white/5 border border-white/15 p-7 rounded-2xl backdrop-blur-md shadow-[0_15px_35px_rgba(0,0,0,0.3)] hover:bg-white/10 hover:border-white/30 transition-all duration-300 space-y-4 group"
              >
                <div className="w-14 h-14 rounded-2xl bg-[#FDD229] text-black flex items-center justify-center font-bold font-serif text-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                  {item.num}
                </div>
                <h3 className="font-serif text-xl font-bold text-white group-hover:text-[#FDD229] transition-colors">{item.title}</h3>
      ...
      <section className="py-20 lg:py-28 bg-[#FBF9F4] border-b border-[#E2E8F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div 
            className="overflow-x-auto rounded-2xl border border-[#E2E8F0] shadow-[0_15px_40px_rgba(0,0,0,0.06)] bg-white no-scrollbar"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={cinematicReveal}
          >
            <table className="w-full text-left border-collapse min-w-[650px]">
              <thead>
                <tr className="bg-[#2D4233] text-white text-xs uppercase font-bold tracking-widest">
                  <th className="p-5 sm:p-6">Season</th>
                  <th className="p-5 sm:p-6">Terroir Condition</th>
                  <th className="p-5 sm:p-6">Harvesting & Processing Activity</th>
                  <th className="p-5 sm:p-6">Purity Impact</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#E2E8F0] text-base text-[#1C241D]">
                <tr className="hover:bg-[#FBF9F4] transition-colors">
                  <td className="p-5 sm:p-6 font-bold flex items-center gap-2.5 text-[#2D4233]">
                    <Moon className="w-5 h-5 shrink-0" /> Winter
                  </td>
                  <td className="p-5 sm:p-6 text-[#64748B]">Snowbound Escarpments</td>
                  <td className="p-5 sm:p-6">Orchards & mountains rest under deep snow. Terroir mineral accumulation.</td>
                  <td className="p-5 sm:p-6 font-semibold text-[#2D4233]">Zero Human Disturbance</td>
                </tr>
                <tr className="hover:bg-[#FBF9F4] transition-colors">
                  <td className="p-5 sm:p-6 font-bold flex items-center gap-2.5 text-[#B58600]">
                    <Sun className="w-5 h-5 shrink-0" /> Spring
                  </td>
                  <td className="p-5 sm:p-6 text-[#64748B]">Glacier Thaw & Bloom</td>
                  <td className="p-5 sm:p-6">Expedition planning, hive inspection & soil nutrient monitoring.</td>
                  <td className="p-5 sm:p-6 font-semibold text-[#2D4233]">Glacial Mineral Flow</td>
                </tr>
                <tr className="hover:bg-[#FBF9F4] transition-colors bg-[#FDD229]/10">
                  <td className="p-5 sm:p-6 font-bold flex items-center gap-2.5 text-[#B58600]">
                    <Flame className="w-5 h-5 shrink-0" /> Summer
                  </td>
                  <td className="p-5 sm:p-6 text-[#1C241D] font-bold">Peak Escarpment Melt</td>
                  <td className="p-5 sm:p-6 font-bold">Limited high-altitude foraging, fruit picking & raw resin collection.</td>
                  <td className="p-5 sm:p-6 font-bold text-[#B58600]">Peak Bio-Active Potency</td>
                </tr>
                <tr className="hover:bg-[#FBF9F4] transition-colors">
                  <td className="p-5 sm:p-6 font-bold flex items-center gap-2.5 text-[#2D4233]">
                    <Leaf className="w-5 h-5 shrink-0" /> Autumn
                  </td>
                  <td className="p-5 sm:p-6 text-[#64748B]">Crisp Mountain Air</td>
                  <td className="p-5 sm:p-6">Slow sun-drying, cold stone milling, PCSIR lab testing & biophotonic sealing.</td>
                  <td className="p-5 sm:p-6 font-semibold text-[#2D4233]">100% Lab Verified Batch</td>
                </tr>
              </tbody>
            </table>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div className="lg:col-span-6 space-y-6" variants={cinematicReveal}>
              ...
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1C241D] leading-tight">
              ...
              <div className="grid grid-cols-3 gap-4 pt-2">
                <div className="p-4 bg-white rounded-2xl border border-[#E2E8F0] text-center shadow-2xs">
                  <strong className="block font-serif text-lg sm:text-xl font-bold text-[#2D4233]">{subData.altitude}</strong>
                  <span className="text-xs text-[#64748B] font-medium">Elevation</span>
                </div>
                <div className="p-4 bg-white rounded-2xl border border-[#E2E8F0] text-center shadow-2xs">
                  <strong className="block font-serif text-lg sm:text-xl font-bold text-[#B58600]">{subData.origin.split(',')[0]}</strong>
                  <span className="text-xs text-[#64748B] font-medium">Region</span>
                </div>
                <div className="p-4 bg-white rounded-2xl border border-[#E2E8F0] text-center shadow-2xs">
                  <strong className="block font-serif text-lg sm:text-xl font-bold text-[#2D4233]">0.00%</strong>
                  <span className="text-xs text-[#64748B] font-medium">Pesticides</span>
                </div>
              </div>
            </motion.div>

            <motion.div className="lg:col-span-6" variants={cinematicReveal}>
              <motion.div 
                className="relative rounded-2xl overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.2)] border border-[#2D4233]/15 aspect-4/3 group"
      ...
      <section className="py-20 lg:py-28 bg-[#162017] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div className="lg:col-span-5 bg-white/5 border border-white/15 p-7 sm:p-9 rounded-2xl backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.4)] space-y-6" variants={cinematicReveal}>
              <div className="flex items-center justify-between border-b border-white/15 pb-4">
                <div>
                  <span className="text-xs text-[#FDD229] font-bold uppercase tracking-wider">Live Batch System</span>
                  <h3 className="font-serif text-2xl font-bold text-white">Batch #BN-2026-SKD</h3>
                </div>
                <QrCode className="w-12 h-12 text-[#FDD229] shrink-0" />
              </div>
              ...
              <div className="space-y-3.5 text-base">
                ...
                <div className="flex justify-between py-1.5">
                  ...
                  <span className="font-bold text-white flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-[#FDD229]" /> Verified Safe</span>
                </div>
              </div>

              <button 
                onClick={() => setQrScanned(!qrScanned)}
                className="w-full py-4 bg-[#FDD229] text-black font-bold text-xs uppercase tracking-widest rounded-xl hover:bg-[#FFE066] active:scale-[0.98] transition-all shadow-lg cursor-pointer"
              >
                {qrScanned ? '✓ Lab Certificate Verified' : 'Simulate Scan QR Code'}
              </button>
            </motion.div>

            <motion.div className="lg:col-span-7 space-y-6" variants={cinematicReveal}>
              ...
              <div className="pt-2 flex flex-wrap items-center gap-5 text-sm font-semibold text-white/90">
                <span className="flex items-center gap-2"><ShieldCheck className="w-5 h-5 text-[#FDD229]" /> PCSIR Certified</span>
                <span className="flex items-center gap-2"><Award className="w-5 h-5 text-[#FDD229]" /> ISO 22000 Facility</span>
              </div>
            </motion.div>
          ...
          >
            {[
              ...
              <motion.div 
                ...
                className="p-6 bg-white rounded-2xl border border-[#E2E8F0] shadow-2xs hover:shadow-xl hover:border-[#2D4233]/30 transition-all duration-300 space-y-3"
              >
                <div className="w-9 h-9 rounded-full bg-[#2D4233]/10 text-[#2D4233] flex items-center justify-center">
                  <Check className="w-5 h-5 stroke-[3]" />
                </div>
                <h4 className="font-serif text-lg font-bold text-[#1C241D]">No {item.label}</h4>
      ...
      <section className="py-20 lg:py-28 bg-[#FBF9F4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {/* Authentic Card */}
            <motion.div 
              className="bg-white p-8 sm:p-10 rounded-3xl border-2 border-[#2D4233] shadow-[0_20px_50px_rgba(45,66,51,0.12)] space-y-6" 
              variants={cinematicReveal}
              whileHover={{ y: -4 }}
            >
              <div className="flex items-center justify-between border-b border-[#E2E8F0] pb-5">
                <div>
                  ...
                  <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#1C241D]">Barn.pk {subData.title}</h3>
                </div>
                <CheckCircle2 className="w-10 h-10 text-[#2D4233] shrink-0" />
              </div>
              
              <ul className="space-y-4 text-base text-[#1C241D]">
            ...
            {/* Counterfeit Card */}
            <motion.div 
              className="bg-white p-8 sm:p-10 rounded-3xl border-2 border-red-200 shadow-[0_20px_50px_rgba(239,68,68,0.08)] space-y-6" 
              variants={cinematicReveal}
              whileHover={{ y: -4 }}
            >
              <div className="flex items-center justify-between border-b border-[#E2E8F0] pb-5">
                <div>
                  ...
                  <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#1C241D]">Diluted Commercial Alternatives</h3>
                </div>
                <AlertTriangle className="w-10 h-10 text-red-500 shrink-0" />
              </div>
              
              <ul className="space-y-4 text-base text-[#475569]">
                <li className="flex items-start gap-3">
      ...
      <section className="py-20 lg:py-28 bg-[#FBF9F4] border-b border-[#E2E8F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div className="bg-white p-7 rounded-2xl border border-[#E2E8F0] shadow-2xs hover:shadow-xl hover:-translate-y-2 transition-all duration-300 space-y-4" variants={cinematicReveal}>
              <Sun className="w-9 h-9 text-[#B58600]" />
            ...
            <motion.div className="bg-white p-7 rounded-2xl border border-[#E2E8F0] shadow-2xs hover:shadow-xl hover:-translate-y-2 transition-all duration-300 space-y-4" variants={cinematicReveal}>
              <Coffee className="w-9 h-9 text-[#2D4233]" />
            ...
            <motion.div className="bg-white p-7 rounded-2xl border border-[#E2E8F0] shadow-2xs hover:shadow-xl hover:-translate-y-2 transition-all duration-300 space-y-4" variants={cinematicReveal}>
              <Flame className="w-9 h-9 text-[#B58600]" />
            ...
            <motion.div className="bg-white p-7 rounded-2xl border border-[#E2E8F0] shadow-2xs hover:shadow-xl hover:-translate-y-2 transition-all duration-300 space-y-4" variants={cinematicReveal}>
              <Moon className="w-9 h-9 text-[#2D4233]" />
      ...
      <section className="py-20 lg:py-28 bg-[#162017] text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <motion.div className="lg:col-span-7 space-y-6" variants={cinematicReveal}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
                <div className="bg-white/10 p-5 rounded-2xl border border-white/15 backdrop-blur-sm">
                  <HeartHandshake className="w-7 h-7 text-[#FDD229] mb-2" />
                ...
                <div className="bg-white/10 p-5 rounded-2xl border border-white/15 backdrop-blur-sm">
                  <Leaf className="w-7 h-7 text-[#FDD229] mb-2" />
                ...
                <div className="bg-white/10 p-5 rounded-2xl border border-white/15 backdrop-blur-sm">
                  <Droplets className="w-7 h-7 text-[#FDD229] mb-2" />
            ...
            <motion.div className="lg:col-span-5" variants={cinematicReveal}>
              <motion.div 
                className="relative rounded-2xl overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.4)] border border-white/20 aspect-4/3 group"
              ...
              >
                ...
                <div className="absolute bottom-5 left-5 right-5 text-white">
                  <span className="text-xs font-bold uppercase text-[#FDD229] drop-shadow-sm">Community Alliance</span>
                  <h4 className="font-serif text-xl font-bold drop-shadow-md">Skardu & Gilgit Farming Families</h4>
                </div>
              </motion.div>
            </motion.div>
